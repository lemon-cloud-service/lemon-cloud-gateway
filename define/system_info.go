...
const SYSTEM_INFO_NAME string = "Lemon Cloud API Gateway"
const SYSTEM_INFO_SERVICE_KEY string = "lemon_cloud_gateway"
const SYSTEM_INFO_SERVICE_INTRODUCE string = "Lemon Cloud API Gateway Service"
